...
> **Goal**: Master Data Structures, Algorithms, Computer Science Fundamentals, and Enterprise Java Engineering to crack top product-based companies (Google, Microsoft, Amazon, Apple, etc.).
...
```bash
javac src/twopointers/ThreeSum.java
java src/twopointers/ThreeSum
```
